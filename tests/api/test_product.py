...
class ProductApiClass(BaseApiClass):
    ENDPOINT = PRODUCTS
...
def test_correct_product_creation(new_random_product):
    ProductApiClass().create_request(new_random_product, expected_id=21)
...
def test_correct_product_update(create_random_product):
    ...
    ProductApiClass().update_request(request)
...
def test_correct_get_product(default_created_product_response):
    ProductApiClass().get_request_by_id(default_created_product_response)
...
def test_correct_get_products(expected_products_response, default_created_product_response):
    ProductApiClass().get_all_request(expected_products_response, default_created_product_response, expected_length=20)
...
def test_correct_delete_product(default_created_product_response):
    ProductApiClass().delete_request(default_created_product_response)
